...
public class QueryTagResponseTest {
    ...
    public void testConstructorNullMapperInvalid() throws IOException {
        new QueryTagResponse(200, new ByteArrayInputStream("bogus".getBytes()));
    }
    ...
    public void getJson() throws IOException {
        ...
        QueryTagResponse response = new QueryTagResponse(200, new ByteArrayInputStream(json.getBytes()));
    ...
    public void getJsonWithErrors() throws IOException {
        ...
        QueryTagResponse response = new QueryTagResponse(400, new ByteArrayInputStream(json.getBytes()));
    ...
    public void getQueriesWith400ErrorNoJson() throws IOException {
        ...
        new QueryTagResponse(400, new ByteArrayInputStream(responseBody.getBytes()));
    }
    ...
    public void getQueriesWith500ErrorNoJson() throws IOException {
        ...
        new QueryTagResponse(500, new ByteArrayInputStream(responseBody.getBytes()));
    }
    ...
    public void getQueriesWith200ErrorNoJson() throws IOException {
        ...
        new QueryTagResponse(200, new ByteArrayInputStream(responseBody.getBytes()));
    }
    ...
    public void getQueriesWith300NoJson() throws IOException {
        ...
        QueryTagResponse response = new QueryTagResponse(300, new ByteArrayInputStream(responseBody.getBytes()));
